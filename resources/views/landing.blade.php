...
@section('content')
    ...
    <div class="landing-wrapper">
        ...
        @isset($post)
            <div class="featured" style="background-image: url({{secure_asset('public/post/'.$post->file)}})">
        ...
        @else
            <div class="featured" style="background-image: url({{secure_asset('public/images/featured_placeholder_3.png')}})">
                <div class="landing-header">
                    <h1>DESIGN, SHARE, EXPLORE & GET INSPIRED</h1>
                    <p>Welcome to MUSEUM, a community for illustrators and designers. Share, feedback and inspire each other.</p>
                </div>
                <div class="featured-artist">
                    <img src="{{secure_asset('public/images/user_placeholder.png')}}" alt="featuredartist">
                    <p>featuredartist</p>
                </div>
            </div>
        @endisset
